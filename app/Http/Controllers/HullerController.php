...
class HullerController extends Controller
{
    ...
    public function location(Request $request){
        ...
        try{
            $url = env('COUCHDB_URL');
            $endpoint = "/varion_huller_location/_find";
            $isByParameter = false;
            ...
            if(!$isByParameter){
                ...
                $count = $client->callApi($url."/varion_huller_location/_all_docs?limit=0", $headerParams, [], "GET");
    ...
    public function transaction(Request $request){
        ...
        try{
            $url = env('COUCHDB_URL');
            $endpoint = "/varion_huller_to_export/_find";
            $isByParameter = false;
            $client = new BaseClient();
            ...
            if(!$isByParameter){
                ...
                $count = $client->callApi($url."/varion_huller_to_export/_all_docs?limit=0", $headerParams, [], "GET");
                $params["limit"] = $count["total_rows"];
            }
