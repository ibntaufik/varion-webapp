<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100" style="">
                    <label style="font-weight: bolder;">{{ __("List of huller") }}</label>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100" style="">
                    <label style="font-weight: bolder;">{{ __("Transaction - huller to export") }}</label>
	...
	$(document).ready(function() {
        ...
        $('#grid-transaction').DataTable( {
			...
			"columnDefs" : [
				...
				{ "targets": 1, "data": "CustomerPO" },
				{ "targets": 2, "data": "EvcCode" },
				{ "targets": 3, "data": "EvcItemQty" },
				{ "targets": 4, "data": "PoNumber" },
				{ "targets": 5, "data": "ShippingDate" },
				{ "targets": 6, "data": "Port" },
				{ "targets": 7, "data": "VchItemQty" },
